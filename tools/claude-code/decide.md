# `/decide` - Claude Code Skill

A skill for Claude Code that enforces structured decision-making and creates Agent Decision Records.

## Installation

Add this to your project's `.claude/commands/decide.md`:
...
```
/decide which database to use for user sessions
```
...
4. Create the AgDR file automatically
